...
{
	return [[NSUserDefaults standardUserDefaults] boolForKey:kUserDefaultsTabsAboveDocumentKey] ? NSMakeSize(NSViewNoInstrinsicMetric, 20) : NSMakeSize(NSViewNoInstrinsicMetric, 24);
}
@end
